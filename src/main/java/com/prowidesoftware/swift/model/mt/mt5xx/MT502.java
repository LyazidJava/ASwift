...
// end qualifiers constants
     ...
     * All mandatory header attributes are completed with default values. In particular the sender and receiver addresses will be
     * filled with proper default LT identifier and branch codes if not provided,
     *
     ...
     * It is kept for compatibility but will be removed very soon, since the <code>messageType</code> parameter is actually ignored.
     ...
     * If the fin parameter is null or the message cannot be parsed, the internal message object will be initialized (blocks will be
     * created) but empty.<br />
    ...
    /**
     * Creates a new MT502 by parsing a String with the message content in its swift FIN format.<br />
     * If the fin parameter cannot be parsed, the returned MT502 will have its internal message object initialized (blocks will be
     * created) but empty.<br />
     * If the string contains multiple messages, only the first one will be parsed.
     *
     * @param fin a string with the MT message in its FIN swift format. <em>fin may be <code>null</code> in which case this method
     * returns null</em>
     ...
     * />
     * If the message content is null or cannot be parsed, the internal message object will be initialized (blocks will be created)
     * but empty.<br />
     ...
     * If the file content is null or cannot be parsed as a message, the internal message object will be initialized (blocks will be
     * created) but empty.<br />
     ...
     *
     * @param file a file with the MT message in its FIN swift format.
     * @return a new instance of MT502 or null if; file is null, does not exist, can't be read, is not a file or the message cannot
     * be parsed
     * @since 7.7
     */
    ...
    /**
     * Iterates through block4 fields and return the first one whose name matches 23G, or <code>null</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return the first one whose name matches 98E, or <code>null</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 94B, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 94C, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 94F, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 94L, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 90A, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 90B, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 22H, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 98B, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 92A, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 95L, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 95S, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 97B, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 97E, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 70C, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 36B, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 19A, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 12A, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 12C, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 12B, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 11A, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 17B, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 35B, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 95C, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 70D, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 92B, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 92C, or
     * <code>Collections.emptyList()</code> if none is found.<br />
    ...
    /**
     * Iterates through block4 fields and return all occurrences of fields whose names matches 99B, or
     * <code>Collections.emptyList()</code> if none is found.<br />
...
// BaseSequenceCodeGenerator [seq=A]
    ...
    public static class SequenceA extends SwiftTagListBlock {
        ...
        /**
         * Create an empty $sequenceClassname. This method is intended to avoid disambiguation for the newInstance() with variable
         * list of blocks or tags
         *
         * @since 7.6
         */
        ...
        /**
         * Create a new instance of $sequenceClassname and add the contents of all sequences given inside. Mainly intended to create
         * a sequence by adding subsequences
         *
         * @since 7.6
         */
    ...
    /**
     * Get the single occurrence of SequenceA delimited by 16R/16S the value of SequenceA#START_END_16RS. The presence of this
     * methods indicates that this sequence can occur only once according to the Standard.
     * <em>NOTE: this method never returns <code>null</code>. If the sequence is not found an empty instance of
     * <code>SequenceA</code> is returned</em>
     *
...
// BaseSequenceCodeGenerator [seq=A1]
    ...
    /**
     * Get the list of SequenceA1 delimited by 16R/16S with value specified in SequenceA1#START_END_16RS The presence of this
     * methods indicates that this sequence can occur more than once according to the Standard. If message is empty or nor sequences
     * are found <em>an empty list</em> is returned.
     *
...
// BaseSequenceCodeGenerator [seq=B]
    ...
    /**
     * Get the single occurrence of SequenceB delimited by 16R/16S the value of SequenceB#START_END_16RS. The presence of this
     * methods indicates that this sequence can occur only once according to the Standard.
     * <em>NOTE: this method never returns <code>null</code>. If the sequence is not found an empty instance of
     * <code>SequenceB</code> is returned</em>
     *
...
// BaseSequenceCodeGenerator [seq=B1]
    ...
    /**
     * Get the list of SequenceB1 delimited by 16R/16S with value specified in SequenceB1#START_END_16RS The presence of this
     * methods indicates that this sequence can occur more than once according to the Standard. If message is empty or nor sequences
     * are found <em>an empty list</em> is returned.
     *
...
// BaseSequenceCodeGenerator [seq=B2]
    ...
    /**
     * Get the list of SequenceB2 delimited by 16R/16S with value specified in SequenceB2#START_END_16RS The presence of this
     * methods indicates that this sequence can occur more than once according to the Standard. If message is empty or nor sequences
     * are found <em>an empty list</em> is returned.
     *
...
// BaseSequenceCodeGenerator [seq=B3]
    ...
    /**
     * Get the single occurrence of SequenceB3 delimited by 16R/16S the value of SequenceB3#START_END_16RS. The presence of this
     * methods indicates that this sequence can occur only once according to the Standard.
     * <em>NOTE: this method never returns <code>null</code>. If the sequence is not found an empty instance of
     * <code>SequenceB3</code> is returned</em>
     *
...
// BaseSequenceCodeGenerator [seq=C]
    ...
    /**
     * Get the single occurrence of SequenceC delimited by 16R/16S the value of SequenceC#START_END_16RS. The presence of this
     * methods indicates that this sequence can occur only once according to the Standard.
     * <em>NOTE: this method never returns <code>null</code>. If the sequence is not found an empty instance of
     * <code>SequenceC</code> is returned</em>
     *
...
// BaseSequenceCodeGenerator [seq=C1]
    ...
    /**
     * Get the list of SequenceC1 delimited by 16R/16S with value specified in SequenceC1#START_END_16RS The presence of this
     * methods indicates that this sequence can occur more than once according to the Standard. If message is empty or nor sequences
     * are found <em>an empty list</em> is returned.
     *
...
// BaseSequenceCodeGenerator [seq=C2]
    ...
    /**
     * Get the list of SequenceC2 delimited by 16R/16S with value specified in SequenceC2#START_END_16RS The presence of this
     * methods indicates that this sequence can occur more than once according to the Standard. If message is empty or nor sequences
     * are found <em>an empty list</em> is returned.
     *
...
// BaseSequenceCodeGenerator [seq=C3]
    ...
    /**
     * Get the list of SequenceC3 delimited by 16R/16S with value specified in SequenceC3#START_END_16RS The presence of this
     * methods indicates that this sequence can occur more than once according to the Standard. If message is empty or nor sequences
     * are found <em>an empty list</em> is returned.
     *
...
// BaseSequenceCodeGenerator [seq=D]
    ...
    /**
     * Get the list of SequenceD delimited by 16R/16S with value specified in SequenceD#START_END_16RS The presence of this methods
     * indicates that this sequence can occur more than once according to the Standard. If message is empty or nor sequences are
     * found <em>an empty list</em> is returned.
     *
...
// BaseSequenceCodeGenerator [seq=E]
    ...
    /**
     * Get the single occurrence of SequenceE delimited by 16R/16S the value of SequenceE#START_END_16RS. The presence of this
     * methods indicates that this sequence can occur only once according to the Standard.
     * <em>NOTE: this method never returns <code>null</code>. If the sequence is not found an empty instance of
     * <code>SequenceE</code> is returned</em>
     *
